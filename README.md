...
- Open issues or PRs as needed. Add tests for new features.

License
-------

This repository does not include a license file. Add a `LICENSE` if you intend to make the project public.

Support / Next steps
--------------------

- I can add a simple moderation wrapper to `chat/ai_service.py` and run a local test against your Ollama server. Tell me if you want that implemented now.
# AI-Chatbot-with-Local-LLM-Django-Ollama-
